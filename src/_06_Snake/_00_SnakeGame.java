...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Move around and get apples to get longer and get more points. Use the arrow keys.";
	...
	private void gameOver() {
		...
		String choicy = JOptionPane.showInputDialog("Say yes if you want to play again");
		//4. if they want to play again
		if(choicy.equals("yes")) {
